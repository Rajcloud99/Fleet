...
const HEADERS = [
	...
	{key: 'grStatus', value: "GR STATUS", width: 8 , style: {fill: HEADER_FILL}},
	...
	{key: 'vehNo', value: "VEHICLE NO.", width: 15 , style: {fill: HEADER_FILL}},
	...
	{key: 'billingRoute', value: "BILLING ROUTE", width: 20 , style: {fill: HEADER_FILL}},
	...
	{key: 'km', value: "KM", width: 20 , style: {fill: HEADER_FILL}},
	{key: 'paymentBasis', value: "PAYMENT BASIS", width: 20 , style: {fill: HEADER_FILL}},
	{key: 'paymentType', value: "PAYMENT TYPE", width: 20 , style: {fill: HEADER_FILL}},
	{key: 'baseValueLabel', value: "CAPACITY", width: 20 , style: {fill: HEADER_FILL}},
	{key: 'fpaNo', value: "FPA NO", width: 20 , style: {fill: HEADER_FILL}},
	...
	{key: 'invNo', value: "INVOICE NO.", width: 15 , style: {fill: HEADER_FILL}},
	{key: 'invAmt', value: "INVOICE AMOUNT", width: 15 , style: {fill: HEADER_FILL}},
	{key: 'loadRefNo', value: "LOAD REF. NO", width: 20 , style: {fill: HEADER_FILL}},
	...
	{key: 'qty', value: "QTY", width: 20 , style: {fill: HEADER_FILL}},
	{key: 'weight', value: "WEIGHT(T)", width: 20 , style: {fill: HEADER_FILL}},
	{key: 'billingUnit', value: "BILLING UNIT", width: 20 , style: {fill: HEADER_FILL}},
	{key: 'billingWeight', value: "BILLING WEIGHT", width: 20 , style: {fill: HEADER_FILL}},
	{key: 'rate', value: "RATE", width: 20 , style: {fill: HEADER_FILL}},
	{key: 'dph', value: "DPH", width: 20 , style: {fill: HEADER_FILL}},
	{key: 'freight', value: "FREIGHT", width: 15 , style: {fill: HEADER_FILL}},
	{key: 'totfreight', value: "TOTAL FREIGHT", width: 15 , style: {fill: HEADER_FILL}},
	...
	{key: 'totAmt', value: "TOTAL AMOUNT", width: 15 , style: {fill: HEADER_FILL}},
	{key: 'totAmtwithDph', value: "TOTAL AAMOUNT WITH DPH", width: 15 , style: {fill: HEADER_FILL}},
	{key: 'totSuppAmt', value: "TOT SUPPLY AMOUNT", width: 15 , style: {fill: HEADER_FILL}},
	...
	{key: 'ewayBill', value: "EWAY BILLS", width: 15 , style: {fill: HEADER_FILL}},
	{key: 'ewayBill', value: "EWAY BILL DATE", width: 15 , style: {fill: HEADER_FILL}},
	{key: 'grRemark', value: "GR REMARK", width: 15 , style: {fill: HEADER_FILL}},
	{key: 'podRem', value: "POD REMARK", width: 15 , style: {fill: HEADER_FILL}},
	{key: 'entryBy', value: "ENTRY BY", width: 15 , style: {fill: HEADER_FILL}},
	{key: 'entryAt', value: "ENTRY AT", width: 15 , style: {fill: HEADER_FILL}},
	{key: 'ownership', value: "OWNERSHIP", width: 15 , style: {fill: HEADER_FILL}},
	// {key: 'routeName', value: "ROUTE NAME", width: 20},
	{key: 'mrRec', value: "MR RECEIVED", width: 15 , style: {fill: HEADER_FILL}},
	{key: 'mrBalFrei', value: "MR BALANCE FREIGHT", width: 15 , style: {fill: HEADER_FILL}},
	...
	{key: 'nonBillGr', value: "NONBILLABLE GR", width: 15 , style: {fill: HEADER_FILL}},
	{key: 'vehOwnerName', value: "VEHICLE OWNER NAME", width: 15 , style: {fill: HEADER_FILL}},
	{key: 'vehOwnerGroup', value: "FLEET", width: 15 , style: {fill: HEADER_FILL}},
	{key: 'segment', value: "SEGMENT", width: 15 , style: {fill: HEADER_FILL}},
...
module.exports = class {
	...
	addRow(doc) {
		...
		row[this.configName(this.configs, 'grStatus', "GR STATUS")] = doc.status || 'NA';
		...
		row[this.configName(this.configs, 'vehNo', "VEHICLE NO.")] = (doc.trip && doc.trip.vehicle_no) || 'NA';
		...
		row[this.configName(this.configs, 'billingRoute', "BILLING ROUTE")] = ((doc.acknowledge && doc.acknowledge.source) ? ((doc.acknowledge.source) + ' to ' + (doc.acknowledge.destination)) : 'NA');
		...
		row[this.configName(this.configs, 'km', "KM")] = doc.invoices && doc.invoices[0] && doc.invoices[0].routeDistance || 'NA';
		row[this.configName(this.configs, 'paymentBasis', "PAYMENT BASIS")] = doc.payment_basis || 'NA';
		row[this.configName(this.configs, 'paymentType', "PAYMENT TYPE")] = doc.payment_type || 'NA';
		row[this.configName(this.configs, 'baseValueLabel', "CAPACITY")] = doc.invoices && doc.invoices[0] && doc.invoices[0].baseValueLabel || 'NA';
		row[this.configName(this.configs, 'fpaNo', "FPA NO")] = (doc.fpa && doc.fpa.refNo) || 'NA';
		...
		row[this.configName(this.configs, 'invNo', "INVOICE NO.")] = doc.invoices && doc.invoices.map(o => o.invoiceNo).join(' ,') || 'NA';
		row[this.configName(this.configs, 'invAmt', "INVOICE AMOUNT")] = doc.invoices && doc.invoices.map(o => o.invoiceAmt).join(' ,') || 'NA';
		// row[this.configName(this.configs, 'incentive', "INCENTIVE")] = doc.charges ? doc.charges.incentive : 'NA';
		row[this.configName(this.configs, 'qty', "QTY")] = doc.invoices.reduce((acc, invcObj) => acc + (invcObj.noOfUnits || 0), 0);
		row[this.configName(this.configs, 'weight', "WEIGHT(T)")] = doc.invoices.reduce((acc, invcObj) => acc + (invcObj.weightPerUnit || 0), 0) + ' T';
		row[this.configName(this.configs, 'billingUnit', "BILLING UNIT")] = doc.invoices.reduce((acc, invcObj) => acc + (invcObj.billingNoOfUnits || 0), 0);
		row[this.configName(this.configs, 'billingWeight', "BILLING WEIGHT")] = doc.invoices.reduce((acc, invcObj) => acc + (invcObj.billingWeightPerUnit || 0), 0);
		...
		row[this.configName(this.configs, 'freight', "FREIGHT")] = parseFloat(doc.basicFreight && doc.basicFreight.toFixed(2) || 0);
		row[this.configName(this.configs, 'totfreight', "TOTAL FREIGHT")] = parseFloat(doc.totalFreight && doc.totalFreight.toFixed(2) || 0);
		...
		row[this.configName(this.configs, 'totAmt', "TOTAL AMOUNT")] = parseFloat(doc.totalAmount && doc.totalAmount.toFixed(2) || 0);
		...
		row[this.configName(this.configs, 'totSuppAmt', "TOT SUPPLY AMOUNT")] = parseFloat(doc.supplementaryBill && doc.supplementaryBill.totalFreight && doc.supplementaryBill.totalFreight.toFixed(2) || 0);
		...
		row[this.configName(this.configs, 'loadRefNo', "LOAD REF. NO")] = doc.invoices && doc.invoices.map(o => o.loadRefNumber).join(' ,') || 'NA';
		...
		row[this.configName(this.configs, 'ewayBill', "EWAY BILLS")] = doc.eWayBills ? doc.eWayBills.map(o => o.number +'('+moment(o.expiry).format("DD-MM-YYYY")+')').join(' ,') : 'NA';
		row[this.configName(this.configs, 'ewayBill', "EWAY BILL DATE")] = doc.eWayBills && doc.eWayBills[0] && doc.eWayBills[0].expiry ? moment(doc.eWayBills[0].expiry).format("DD-MM-YYYY") : 'NA';
		row[this.configName(this.configs, 'grRemark', "GR REMARK")] = doc.remarks || 'NA';
		row[this.configName(this.configs, 'podRem', "POD REMARK")] = doc.pod && doc.pod.arRemark || 'NA';
		...
		row[this.configName(this.configs, 'ownership', "OWNERSHIP")] = (doc.trip && doc.trip.ownershipType) || 'NA';
		...
		row[this.configName(this.configs, 'mrRec', "MR RECEIVED")] = mrRec || 'NA';
		let mrBalFr = (((doc.totalFreight || 0) + (doc.supplementaryBill && doc.supplementaryBill.totalFreight || 0)) - mrRec);
		row[this.configName(this.configs, 'mrBalFrei', "MR BALANCE FREIGHT")] = mrBalFr || 'NA';
		...
		row[this.configName(this.configs, 'nonBillGr', "NONBILLABLE GR")] = (doc.isNonBillable) ? "Yes" : "No";
		row[this.configName(this.configs, 'vehOwnerName', "VEHICLE OWNER NAME")] = doc.vehicle && doc.vehicle.owner_name || 'NA';
		row[this.configName(this.configs, 'vehOwnerGroup', "FLEET")] = doc.vehicle && doc.vehicle.owner_group || 'NA';
		row[this.configName(this.configs, 'segment', "SEGMENT")] = (doc.trip && doc.trip.segment_type) || 'NA';
